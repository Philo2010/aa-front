...
export type Edit = {
    ...
    auto_paths?: Array<Array<Array<PathPoint>>> | null;
    years_of_driver_experience?: number | null;
    what_they_are_looking_from_the_tournament?: string | null;
    do_they_have_a_scouter?: boolean | null;
    how_many_batteries_do_they_have_on_hand?: number | null;
    willing_to_play_defence?: boolean | null;
    strategy?: string | null;
    can_pass?: boolean | null;
...
export type Model = {
    ...
    how_many_batteries_do_they_have_on_hand: number;
    willing_to_play_defence: boolean;
    strategy: string;
    can_pass: boolean;
    can_shoot: boolean;
    climb: ClimbState;
...
export type Insert = {
    drivebase: Drivebase;
    auto_paths: Array<Array<Array<PathPoint>>>;
    years_of_driver_experience: number;
    what_they_are_looking_from_the_tournament: string;
    do_they_have_a_scouter: boolean;
    how_many_batteries_do_they_have_on_hand: number;
...
export type ApiResultForArrayOfGamePart = {
    status: 'Success';
    message: Array<GamePart>;
} | {
    status: 'Error';
    message: string;
};
...
export type ScoutGame = {
    red_1: Array<ScoutMatch>;
    red_2: Array<ScoutMatch>;
    red_3: Array<ScoutMatch>;
    blue_1: Array<ScoutMatch>;
    blue_2: Array<ScoutMatch>;
    blue_3: Array<ScoutMatch>;
};
...
export type ScoutMatch = {
    ...
    is_redo: boolean;
    team: Team;
    data?: ScoutMatchData | null;
};

export type ScoutMatchData = {
    match_id: number;
    set: number;
    total_score: number;
    teleop_score: number;
...
export type MvpPairPart = {
    red?: MvpUpcoming | null;
    blue?: MvpUpcoming | null;
};

export type MvpUpcoming = {
    id: number;
    name: string;
    data?: MvpData | null;
};
...
export type GetPickListRequest = {
    include_midway: boolean;
};

export type SetPick = {
    team: Team;
    event_code: string;
    is_selected_defence?: boolean | null;
    is_selected_offence?: boolean | null;
    is_selected_general?: boolean | null;
};
...
export type GetYearsResponses = {
    200: ApiResultForArrayOfGamePart;
};
...
export type GetPickListData = {
    body: GetPickListRequest;
    path?: never;
    query?: never;
    url: '/api/pick_list';
};

export type GetPickListResponses = {
    200: ApiResultForPickLists;
};

export type GetPickListResponse = GetPickListResponses[keyof GetPickListResponses];

export type SetPickListData = {
    body: SetPick;
    path?: never;
    query?: never;
...
export type SetPickListResponses = {
    200: ApiResultForString;
};

export type SetPickListResponse = SetPickListResponses[keyof SetPickListResponses];
